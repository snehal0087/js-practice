...
function randomQuote() {
    let quoteStr = quotes[Math.floor(Math.random() * quotes.length)];
   let quoteText = document.getElementById("quoteString");
  
    console.log(quoteStr.quote);
    console.log(quoteStr.author);

    quoteText.innerText = quoteStr.quote;
    let quoteSource = document.querySelector("source");
    quoteSource.textContent = quoteStr.author;
}
randomQuote();
